...
import ServicesPanel from '@/components/apwhy/ServicesPanel';
import KeysPanel from '@/components/apwhy/KeysPanel';
import AnalyticsPanel from '@/components/apwhy/AnalyticsPanel';

interface ServiceNode {
  id: string;
  name: string;
  type: 'app' | 'database' | 'worker' | 'api' | 'cron' | 'static' | 'gateway';
...
const mockServices: ServiceNode[] = [
  ...
  },
  {
    ...
    type: 'gateway',
    status: 'running',
    url: 'https://gateway.containr.dev',
    lastDeploy: '2 hours ago',
    cpu: '120m',
    memory: '180Mi',
    connections: ['1', '2', '3'],
    ...
    enabled: true,
    routePrefix: '/api/v1',
    upstreamUrl: 'https://api.containr.dev',
    rpmLimit: 1000,
...
export function ProjectCanvas() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'deployments' | 'variables' | 'metrics' | 'gateway'>('overview');
  ...
  return (
    <Card className="w-full">
      ...
      <CardContent className="space-y-4">
        {/* Global API Gateway Section */}
        <Card className="border-primary/20 bg-primary/5">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Shield className="w-5 h-5 text-primary" />
                <CardTitle className="text-lg font-semibold">API Gateway Control Center</CardTitle>
          ...
          <div className="mt-6 p-4 rounded-lg border bg-muted/50">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-1 bg-muted rounded-lg p-1">
                {(['overview', 'deployments', 'variables', 'metrics', 'gateway'] as const).map((tab) => (
                  <Button
                    key={tab}
                  ...
                  >
                    {tab === 'gateway' ? <Key className="w-3 h-3 mr-1" /> : null}
                    {tab}
                  </Button>
                ))}
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <div className="text-xs text-muted-foreground">8 active, 4 inactive</div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <div className="text-xs text-muted-foreground">+15% from yesterday</div>
                    </CardContent>
                  </Card>
                </div>

                {/* Integrated APwhy Panels */}
