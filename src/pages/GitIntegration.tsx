  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 space-y-8">
      <PageHeader
        ...
        description="Connect your Git repositories and automate deployments"
        action={{
          label: 'Add Provider',
          icon: IconPlus,
        ...
        {providers.length === 0 ? (
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {providers.map((provider) => (
              <Card key={provider.id} className="card-hover card-elevated group">
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 rounded-lg ${getProviderColor(provider.name)} flex items-center justify-center text-white shadow-lg`}>
